...
const SECTIONS = [
  ...
  },
  {
    ...
    items: [
      ...
      'Google AdMob（広告配信・広告メディエーション）',
      'Unity Ads（広告配信）',
      'Meta Audience Network（広告配信）',
    ],
    afterItems: [
  ...
  },
  {
    title: '第5条（広告について）',
    paragraphs: [
      '本サービスでは、Google AdMobによる広告メディエーションを通じて、Unity Ads・Meta Audience Network等の第三者配信の広告サービスを利用する場合があります。',
      '広告配信事業者は、ユーザーの興味・関心に応じた広告を表示するため、広告識別子等の情報を利用することがあります。',
      'iOS端末では、App Tracking Transparency（ATT）フレームワークに基づき、トラッキングの許可をユーザーに確認した上で広告識別子（IDFA）を利用します。ユーザーはいつでも端末の設定からトラッキングの許可状況を変更できます。',
    ],
  },
  {
    title: '第6条（情報の管理）',
