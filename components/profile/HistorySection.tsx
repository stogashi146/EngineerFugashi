...
const histories = [
  {
    id: 1,
    company: '1社目（エンジニアとしての基盤を築いた時期）',
    period: '2014年04月〜2020年9月',
    description: `高校卒業後はWEBアプリの運用保守・テストや、インフラ構築まで幅広く担当し、IT基盤とシステム運用の経験を積みました。
...
この期間に、後の開発業務につながる基礎技術とコミュニケーション力を身につけました。`,
  },
  {
    ...
    period: '2020年10月〜2021年11月',
    description: `前職ではテストがメイン業務だったため、将来のキャリアを考えてプログラミングスクールに通うことにしました。
